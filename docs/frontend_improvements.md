# StemScriberr Frontend Improvements -- Research & Proposals
...
## Part 3: Proposed Improvements for StemScriberr
...
**Why:** This is the core UX of any stem separation tool. Moises, LALAL.AI, and every competitor does this. Without it, StemScriberr feels incomplete.
...
**Why:** This is the "wow factor" that differentiates StemScriberr from plain stem separators. Seeing your transcribed music as playable, interactive tabs is the core value proposition.
...
**What:** Share a StemScriberr session via URL with custom stem mix settings.
...
**Why:** BandLab proves that collaboration drives engagement. A band could share a StemScriberr link and discuss parts.
